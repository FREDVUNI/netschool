<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h4 class="m-0 text-dark">Edit term</h4>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <?php echo $this->session->flashdata('message');?>
            ...
            <div class="card-header">
              ...
              <div class="card-body">
              <form id="editterm" action="<?php echo base_url('/admin/'.$term['slug'].'/term'); ?>" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                <div class="col-md-12">
                    <div class="form-group ">
                        <label for="term">Term <span class="text-danger">*</span> </label>
                        <input type="hidden" name="term_id" value="<?php echo $term['term_id']; ?>">
                        <input type="text" name="term" id="term" class="form-control <?php if(form_error('term')): echo "is-invalid"; endif;?>" placeholder="Enter term name" value="<?php echo $term['term'] ?? set_value('term');?>" autofocus="autofocus" required pattern="^[A-Za-z0-9_- ]$">
                        <span class="invalid-feedback"><?php echo form_error('term');?></span>
                    </div>
                    <div class="form-group ">
                        <label for="level">Level <span class="text-danger">*</span> </label>
                        <select name="level" id="level" class="form-control">
                            <option value="<?php echo $term['level_id'] ?? set_value('level_id');?>">
                            <?php echo $term['level'] ?? set_value('level');?>
                            </option>
