<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h4 class="m-0 text-dark">Edit subject</h4>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <?php echo $this->session->flashdata('message');?>
            ...
            <div class="card-header">
              ...
              <div class="card-body">
              <form id="editsubject" action="<?php echo base_url('/admin/'.$subject['slug'].'/subject'); ?>" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                <div class="col-md-12">
                    <div class="form-group ">
                        <label for="subject">Subject <span class="text-danger">*</span> </label>
                        <input type="hidden" name="subject_id" value="<?php echo $subject['subject_id']; ?>">
                        <input type="text" name="subject" id="subject" class="form-control <?php if(form_error('subject')): echo "is-invalid"; endif;?>" placeholder="Enter subject" value="<?php echo $subject['subject'] ?? set_value('subject');?>" autofocus="autofocus" required pattern="^[A-Za-z0-9_- ]$">
                    ...
                    <div class="row">
                        ...
                        <label for="image">Thumbnail <span class="text-danger">*</span> </label>
                            <div class="d-flex flex-row">
                                <img src="<?php echo $subject['image'];?>" alt="user" class=""  id="thumbImage" width="140" height="140">
...
$('#image').change(function () {
    ...
    function DeleteImage() {
        $('#thumbImage').attr('src', '<?php echo base_url('assets/backend/images/uploads/subjects/').$subject['image'];?>');
        $('#imageerror').text('')
    }
    </script>