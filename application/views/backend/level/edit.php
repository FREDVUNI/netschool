<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h4 class="m-0 text-dark">Edit level</h4>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <?php echo $this->session->flashdata('message');?>
            ...
            <div class="card-header">
              ...
              <div class="card-body">
              <form id="editlevel" action="<?php echo base_url('/admin/'.$level['slug'].'/level'); ?>" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                <div class="col-md-12">
                    <div class="form-group ">
                        <label for="level">Level <span class="text-danger">*</span> </label>
                        <input type="hidden" name="level_id" value="<?php echo $level['level_id']; ?>">
                        <input type="text" name="level" id="level" class="form-control <?php if(form_error('level')): echo "is-invalid"; endif;?>" placeholder="Enter Level name" value="<?php echo $level['level'] ?? set_value('level');?>" autofocus="autofocus" required pattern="^[A-Za-z0-9_- ]$">
