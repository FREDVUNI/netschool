<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h4 class="m-0 text-dark">Lessons</h4>
          </div>
          <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card-header">
                    <!-- <a class="text-secondary text-sm float-right" href="<?php // echo base_url('admin/lesson/store'); ?>">
                ...
                <div class="card-body">
                    ...
                    <?php foreach($lessons as $key => $lesson): ?>
                        <tr>
                            ...
                            <td><?php echo word_limiter($lesson['title'],4);?></td>
                            <td><?php echo word_limiter($lesson['topic'],2);?></td>
                            <td><?php echo $lesson['level'];?></td>
                            <td><?php echo $lesson['subject'];?></td>
                            <td>
                                <!-- <a href="<?php // echo base_url('/admin/'.$lesson['slug'].'/lesson');?>" class="btn btn-light btn-sm text-muted"><i class="fa fa-pencil-alt text-muted"></i></a>
        ...
        <div class="modal" id="delete<?php echo $lesson['slug'];?>">
          <div class="modal-dialog modal-confirm" role="document">
            ...
            <div class="modal-footer justify-content-center">
              <?php echo form_open_multipart('admin/lesson/'.$lesson['lesson_id'].'/delete');?>
