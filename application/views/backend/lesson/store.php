<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h4 class="m-0 text-dark">Create Lesson</h4>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <?php echo $this->session->flashdata('message');?>
            ...
            <div class="card-header">
              ...
              <div class="card-body">
              <form id="createlesson" action="<?php echo base_url('admin/lesson/store'); ?>" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                <div class="col-md-12">
                    ...
                    <div class="form-group ">
                        ...
                        <option value="" autofocus>choose a topic</option>
